...
/*
  ...
  TEST CASE 246: nanoseconds elapsed: 146971000
	...
	*/
	...
	)
	{
		...
		*/
		...
		Tasks_Thread.emplace/*push*/(Theorem_UInt64Vec);
				...
				*/
				...
				for (const auto& Axiom : Axioms_UInt64Vec)
				{
					...
					if (theoremLHS % AxiomLHS == 0)
					{
						...
						Tasks_Thread.emplace/*push*/(Theorem_0000);
					}
					...
					if (theoremLHS % AxiomRHS == 0)
					{
						...
						Tasks_Thread.emplace/*push*/(Theorem_0001);
					}
					...
					if (theoremRHS % AxiomLHS == 0)
					{
						...
						Tasks_Thread.emplace/*push*/(Theorem_0002);
					}
					...
					if (theoremRHS % AxiomRHS == 0)
					{
						...
						Tasks_Thread.emplace/*push*/(Theorem_0003);
					}
