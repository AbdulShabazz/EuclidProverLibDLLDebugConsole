...
/*
  ...
  TEST CASE 246: nanoseconds elapsed: 186466300
		...
		while (!Tasks_Thread.empty() && !QED)
		{
			...
			if (TentativeProofFound_Flag)
			{
				...
				*/
				...
				auto lhs_reduce = AxiomCallGraphMap;
				auto lhs_expand = AxiomCallGraphMap;
				auto rhs_reduce = AxiomCallGraphMap;
				auto rhs_expand = AxiomCallGraphMap;
				...
				for (const auto& Axiom : Axioms_UInt64Vec)
				{
					...
					if (lhs_reduce[Theorem[guid_UInt64]][Axiom[guid_UInt64]] || theoremLHS % AxiomLHS == 0)
					{
						if (!lhs_reduce[Theorem[guid_UInt64]][Axiom[guid_UInt64]]) 
							lhs_reduce[Theorem[guid_UInt64]][Axiom[guid_UInt64]] = true;
					...
					if (lhs_expand[Theorem[guid_UInt64]][Axiom[guid_UInt64]] || theoremLHS % AxiomRHS == 0)
					{
						if (!lhs_expand[Theorem[guid_UInt64]][Axiom[guid_UInt64]])
							lhs_expand[Theorem[guid_UInt64]][Axiom[guid_UInt64]] = true;
					...
					if (rhs_reduce[Theorem[guid_UInt64]][Axiom[guid_UInt64]] || theoremRHS % AxiomLHS == 0)
					{
						if (!rhs_reduce[Theorem[guid_UInt64]][Axiom[guid_UInt64]])
							rhs_reduce[Theorem[guid_UInt64]][Axiom[guid_UInt64]] = true;
					...
					if (rhs_expand[Theorem[guid_UInt64]][Axiom[guid_UInt64]] || theoremRHS % AxiomRHS == 0)
					{
						if (!rhs_expand[Theorem[guid_UInt64]][Axiom[guid_UInt64]])
							rhs_expand[Theorem[guid_UInt64]][Axiom[guid_UInt64]] = true;
