...
/*
  ...
  TEST CASE 246: nanoseconds elapsed: 220809700
		...
		while (!Tasks_Thread.empty() && !QED)
		{
			...
			if (TentativeProofFound_Flag)
			{
				...
				*/
				...
				auto RouteCacheMap = AxiomCallGraphMap;
				...
				for (const auto& Axiom : Axioms_UInt64Vec)
				{
					...
					if (RouteCacheMap[theoremLHS][AxiomLHS] || theoremLHS % AxiomLHS == 0)
					{
						RouteCacheMap[theoremLHS][AxiomLHS] = true;
					...
					if (RouteCacheMap[theoremLHS][AxiomRHS] || theoremLHS % AxiomRHS == 0)
					{
						RouteCacheMap[theoremLHS][AxiomRHS] = true;
					...
					if (RouteCacheMap[theoremRHS][AxiomLHS] || theoremRHS % AxiomLHS == 0)
					{
						RouteCacheMap[theoremRHS][AxiomLHS] = true;
					...
					if (RouteCacheMap[theoremRHS][AxiomRHS] || theoremRHS % AxiomRHS == 0)
					{
						RouteCacheMap[theoremRHS][AxiomRHS] = true;
