...
template <
    const RouteSource_EnumClass RouteSource_EnumClass_Param,
    const Indirection_EnumClass Indirection_EnumClass_Param> // Declaration of the primary template function
__forceinline void Auto(
...
template <>	// Template specialization of the primary template function
__forceinline void Auto <
    RouteSource_EnumClass::_root,
    Indirection_EnumClass::_auto >(
        Theorem_Struct InTheorem,
        const Axiom_Struct& InAxiom,
        const bool& InProofFound_ParameterFlag,
        const bool& InTotalProofsGEMaxAllowedProofs_ParameterFlag)
{
