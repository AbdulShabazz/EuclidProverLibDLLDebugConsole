...
/*
  ...
  TEST CASE 246: nanoseconds elapsed: 205743400
			...
			if (TentativeProofFound_Flag)
			{
				...
				*/
				...
				for (const auto& Axiom : Axioms_UInt64Vec)
				{
					...
					if (lhs_reduce[theoremLHS][AxiomLHS] || theoremLHS % AxiomLHS == 0)
					{
						lhs_reduce[theoremLHS][AxiomLHS] = true;
					...
					if (lhs_expand[theoremLHS][AxiomRHS] || theoremLHS % AxiomRHS == 0)
					{
						lhs_expand[theoremLHS][AxiomRHS] = true;
					...
					if (rhs_reduce[theoremRHS][AxiomLHS] || theoremRHS % AxiomLHS == 0)
					{
						rhs_reduce[theoremRHS][AxiomLHS] = true;
					...
					if (rhs_expand[theoremRHS][AxiomRHS] || theoremRHS % AxiomRHS == 0)
					{
						rhs_expand[theoremRHS][AxiomRHS] = true;
